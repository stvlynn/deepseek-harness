/**
 * Account Service Definition class. The in-memory test double extends this
 * module rather than the package barrel so the two files do not import each
 * other.
 * @module @deepseek-ai/dsh-account/src/service
 */
